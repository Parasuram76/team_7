...
const api = {
  ...
  socraticChat: async (payload) => {
    const response = await apiClient.post("/tools/socratic-chat", payload);
    return response.data;
  },
  getSocraticSessions: async () => {
    const response = await apiClient.get("/tools/socratic-sessions");
    return response.data;
  },
  getSocraticSession: async (sessionId) => {
    const response = await apiClient.get(`/tools/socratic-session/${sessionId}`);
    return response.data;
  },
  deleteSocraticSession: async (sessionId) => {
    const response = await apiClient.delete(`/tools/socratic-session/${sessionId}`);
    return response.data;
  },
